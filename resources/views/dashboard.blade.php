...
<div class="row">
    <div class="col-12 col-md-12 col-xs-12 col-lg-12">
        <div class="text-end my-4">
            <button class="btn btn-primary text-end" onclick="openModal(this)" style="color: white; background: linear-gradient(315deg, #e91e63, #5d02ff); border: none;" data-type="new">Add Site</button>
        </div>
        <table class="table table-responsive" id="sitesTable">
            ...
            <tbody>
                ...
                <td>
                    ...
                    <button type="button" class="btn btn-info btn-sm" onclick="openModal(this)" data-type="edit" data-id="{{$site->id}}" data-url="{{$site->url}}" data-frequency="{{$site->frequency}}"><i class="fa fa-edit"></i></button>
                </td>
                </tr>
                @endforeach --}}
            </tbody>
    ...
    <div class="modal-dialog">
        <div class="modal-content">
            <div class="modal-header">
                ...
                <button type="button" class="btn-close" data-bs-dismiss="modal" aria-label="Close"> <span aria-hidden="true" style="color: white;">&times;</span></button>
            </div>
                    ...
                    <div class="form-group">
                        <div class="row">
                            ...
                            <div class="col-12 col-md-12 col-lg-12 col-xs-12 mt-2">
                                ...
                                <input type="website" name="url" id="url" placeholder="Site URL" class="form-control" required>
                            </div>
                            <div class="col-12 col-md-12 col-lg-12 col-xs-12 mt-2">
                                <label for="frequency" style="color: #fff;">Task Frequency</label>
                                <input type="text" name="frequency" id="frequency" placeholder="Task Frequency" class="form-control" required>
                            </div>
                        </div>
                    </div>
                </form>
            ...
            <div class="modal-footer">
                ...
                <button type="button" class="btn btn-primary" style="background: linear-gradient(315deg, #e91e63, #5d02ff); border:none;" id="siteModalButton" data-type onclick="handleClick(this);"></button>
            </div>
        </div>
    </div>
</div>
    ...
    $('#siteForm').submit(function(event) {
        ...
        if (validate()) {
            ...
            $.ajax({
                ...
                error: function() {
                    $('#alert').text('error occured, please try again');
                }
            });
        }
    });
