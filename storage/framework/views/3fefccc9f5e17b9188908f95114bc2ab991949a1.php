...
<?php $__env->startSection('heading', 'Sites Available'); ?>
    ...
    <div class="row">
        <div class="col-12 col-md-12 col-xs-12 col-lg-12">
            <div class="text-end my-4">
                <button class="btn btn-primary text-end" onclick="openModal(this)" data-type="new">Add Site</button>
            </div>
            <table class="table table-responsive table-active" id="sitesTable">
                <thead>
                    <th>#</th>
                    <th>Site Name</th>
                    <th>Status</th>
            ...
            <div class="modal-content">
                ...
                <div class="modal-footer">
                    <button type="button" class="btn btn-secondary" data-bs-dismiss="modal"
                        id="siteModalClose">Close</button>
                    <button type="button" class="btn btn-primary" id="siteModalButton" data-type
    ...
    <script>
        ...
        $(document).ready(function() {
            ...
            table = $('#sitesTable').DataTable({
                ...
                serverSide: true,
                responsive: true,
                ajax: "<?php echo e(route('site-monitor.index')); ?>",
                columns: [{
                        data: 'DT_RowIndex',
                        name: 'DT_RowIndex'
                    },
            ...
            if (validate()) {
                switch (type) {
                    case "new":
                        params = {
                            method: "POST",
                            url: "<?php echo e(route('site-monitor.store')); ?>",
                            data: {
                        ...
                        break;
                    default:
                        var url = "<?php echo e(route('site-monitor.update', '--PARAM--')); ?>";
...
<?php echo $__env->make('layout.app', \Illuminate\Support\Arr::except(get_defined_vars(), ['__data', '__path']))->render(); ?><?php /**PATH C:\laragon\www\laravel\assignment\resources\views/dashboard.blade.php ENDPATH**/ ?>